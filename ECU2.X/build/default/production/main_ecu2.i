...
void main(void)
{
    ...
    TRISB = TRISB | 0X80;
     init_can();
    PORTB = 0x00;
    unsigned int r_msz_id, r_len, i_msz, i_len;
    unsigned char r_ssd[4], arr_led[1], rec_arr_led[3];
