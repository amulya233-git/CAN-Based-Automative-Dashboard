...
void main(void)
{
    ...
    while(1)
    {
        ...
        clcd_print("SP  GR  RPM  ID", (0x80 + (0)));
        ...
        {
            recv_data[2] = '\0';
            clcd_print(recv_data, (0xC0 + (0)));
        }


        else if(0x20 == recv_msg_id)
        {
            recv_data[2] = '\0';
            clcd_print(recv_data, (0xC0 + (4)));
        }


        else if(0x30 == recv_msg_id)
        {
            recv_data[recv_length] = '\0';
            clcd_print(recv_data, (0xC0 + (7)));
        }


        else if(0x50 == recv_msg_id)
        {
